...
function Currency() {
  ...
  const currencyCode = [
    ...
    { value: "CKD", label: "Cook Islands Dollar" },
    ...
    { value: "CVE", label: "Cabo Verdean Escudo" },
    ...
    { value: "EHP", label: "Sahrawi Peseta" },
    ...
    { value: "PND", label: "Pitcairn Islands Dollar" },
    ...
    { value: "STN", label: "Sao Tome and Príncipe Dobra" },
    ...
    { value: "VED", label: "Venezuelan bolívar digital" },
  ...
  return (
    <>
      ...
      <div className='container'>
        <Typography.Title className='title'>Currency</Typography.Title>
        <Typography.Title level={5} className='title'>
          Check exchange rate easily!
        </Typography.Title>
